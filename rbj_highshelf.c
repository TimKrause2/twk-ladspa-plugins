...
static LADSPA_Handle HighShelf_instantiate(
	const struct _LADSPA_Descriptor *p_pDescriptor,
	unsigned long p_sample_rate ){
	HighShelf_Data *l_pLowShelf = malloc( sizeof(HighShelf_Data) );
	if( l_pLowShelf ){
...
static void HighShelf_connect_port(
	LADSPA_Handle p_pInstance,
	unsigned long p_port,
	LADSPA_Data  *p_pdata)
{
	HighShelf_Data *l_pLowShelf = (HighShelf_Data*)p_pInstance;
	l_pLowShelf->m_pport[p_port] = p_pdata;
}

static void HighShelf_run(
	LADSPA_Handle p_pInstance,
...
static void HighShelf_cleanup( LADSPA_Handle p_pInstance )
{
	free( p_pInstance );
}

static LADSPA_PortDescriptor HighShelf_PortDescriptors[]=
{
...
static const char *HighShelf_PortNames[]=
{
	"Input",
	"Output",
	"Frequency(Hz)",
...
static LADSPA_PortRangeHint HighShelf_PortRangeHints[]=
{
	{0,0,0},
	{0,0,0},
...
LADSPA_Descriptor RBJHighShelf_Descriptor=
{
	5819,
	"RBJ_highshelf",
	...
	"None",
	PORT_NPORTS,
	HighShelf_PortDescriptors,
	HighShelf_PortNames,
	HighShelf_PortRangeHints,
	NULL,
	HighShelf_instantiate,
	HighShelf_connect_port,
	NULL,
	HighShelf_run,
	NULL,
	NULL,
